...
absFilePath = os.path.abspath(__file__)                # Absolute Path of the mo
print(absFilePath)
fileDir = os.path.dirname(os.path.abspath(__file__))   # Directory of the Module
fileDir = os.path.dirname(fileDir) 

TRAIN_SCRIPT_PATH='/scripts/data/train_iris.csv'
PREDICT_SCRIPT_PATH='/scripts/data/predict_iris.csv'
MODEL_PATH='/scripts/data/model_v1.sav'
TRAIN_DATA_PATH='/scripts/data/train_data.csv'
PREDICT_DATA_PATH='/scripts/data/predict_data.csv'

TRAIN_SCRIPT_PATH = os.path.join(fileDir + TRAIN_SCRIPT_PATH)
PREDICT_SCRIPT_PATH = os.path.join(fileDir + PREDICT_SCRIPT_PATH)
MODEL_PATH = os.path.join(fileDir + MODEL_PATH)
TRAIN_DATA_PATH = os.path.join(fileDir + TRAIN_DATA_PATH) 
PREDICT_DATA_PATH = os.path.join(fileDir + PREDICT_DATA_PATH)
